...
[материалом](https://dyakonov.org/2016/11/14/%D1%81%D0%BB%D1%83%D1%87%D0%B0%D0%B9%D0%BD%D1%8B%D0%B9-%D0%BB%D0%B5%D1%81-random-forest/comment-page-1/):
  ...
  - Лучшим значением параметра `max_features` оказалось значение (долгий подбор, возможно,
    значения получатся на следующий день)
...
Теперь пробую провести приближение для всей выборки, а не только для 42-х значимых признаков.
---
